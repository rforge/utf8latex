...
is.isalnum<-function(utf8char) .Call("is_isalnum",as.character(utf8char),PACKAGE="utf8latex") 
is.isalpha<-function(utf8char) .Call("is_isalpha",as.character(utf8char),PACKAGE="utf8latex")
is.ascii<-function(utf8char) .Call("is_ascii",as.character(utf8char),PACKAGE="utf8latex")
is.isblank<-function(utf8char) .Call("is_isblank",as.character(utf8char),PACKAGE="utf8latex")
is.iscntrl<-function(utf8char) .Call("is_iscntrl",as.character(utf8char),PACKAGE="utf8latex")
is.isdigit<-function(utf8char) .Call("is_isdigit",as.character(utf8char),PACKAGE="utf8latex")
is.isgraph<-function(utf8char) .Call("is_isgraph",as.character(utf8char),PACKAGE="utf8latex")
is.islower<-function(utf8char) .Call("is_islower",as.character(utf8char),PACKAGE="utf8latex")
is.isprint<-function(utf8char) .Call("is_isprint",as.character(utf8char),PACKAGE="utf8latex")
is.ispunct<-function(utf8char) .Call("is_ispunct",as.character(utf8char),PACKAGE="utf8latex")
is.isspace<-function(utf8char) .Call("is_isspace",as.character(utf8char),PACKAGE="utf8latex")
is.isupper<-function(utf8char) .Call("is_isupper",as.character(utf8char),PACKAGE="utf8latex")
is.isxdigit<-function(utf8char) .Call("is_isxdigit",as.character(utf8char),PACKAGE="utf8latex")
